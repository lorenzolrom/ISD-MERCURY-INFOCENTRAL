...
use models\itsm\PurchaseOrderCommodity;
use models\itsm\PurchaseOrderCostItem;
...
class PurchaseOrderDatabaseHandler extends DatabaseHandler
{
    ...
    public static function selectCommodityById(int $id)
    {
        ...
        return $select->fetchObject('models\itsm\PurchaseOrderCommodity');
    }
    ...
    public static function selectCostItemById(int $id)
    {
        ...
        return $select->fetchObject('models\itsm\PurchaseOrderCostItem');
    }

...
use extensions\forms\models\Field;
...
class FieldDatabaseHandler extends DatabaseHandler
{
    ...
    public static function select(int $id): Field
    {
        ...
        return $select->fetchObject('extensions\forms\models\Field');
    }
    ...
    public static function selectByForm(int $formId): array
    {
        ...
        return $select->fetchAll(DatabaseConnection::FETCH_CLASS, 'extensions\forms\models\Field');
    }
